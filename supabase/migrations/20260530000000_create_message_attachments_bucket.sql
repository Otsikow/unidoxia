-- =============================================================================
-- Ensure message attachment uploads have a dedicated storage bucket
-- =============================================================================
-- This migration guarantees the message-attachments bucket exists with the
-- correct configuration and policies so chat uploads no longer fail with
-- "Bucket not found" errors.
-- =============================================================================

-- Create or update the message-attachments bucket with sensible defaults
...
-- Ensure storage policies exist for public reads and authenticated writes
DO $$
BEGIN
  IF NOT EXISTS (
