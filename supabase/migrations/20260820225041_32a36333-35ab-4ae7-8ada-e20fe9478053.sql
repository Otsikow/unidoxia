...
CREATE OR REPLACE FUNCTION public.search_programmes(p_query text DEFAULT ''::text, p_country text DEFAULT NULL::text, p_level text DEFAULT NULL::text, p_intake_year integer DEFAULT NULL::integer, p_intake_month integer DEFAULT NULL::integer, p_limit integer DEFAULT 24, p_offset integer DEFAULT 0)
...
GRANT EXECUTE ON FUNCTION public.search_programmes(text, text, text, integer, integer, integer, integer) TO anon, authenticated, service_role;