...
const datasetPath = new URL("../../data/catalogues/georgian-college-stem-expansion.json", import.meta.url);
const outputPath = new URL("../../supabase/migrations/20260820190000_georgian_college_stem_expansion.sql", import.meta.url);
...
lines.push(`UPDATE public.universities SET
  ...
  academic_year = ${quote(dataset.academicYear)},
