...
const EditorialPolicy = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <p className="text-muted-foreground">
        Where an article shows a “Last checked” date, that is the most recent date on
        which the article was checked against its linked official sources. Rules can
        change at any time, so readers should still confirm the linked official source
        before acting.
      </p>
      ...
      <p className="text-muted-foreground">
        ...
        Our policy is to update the article, refresh the source-check date, and note
        material corrections in the article itself.
      </p>
      ...
      <p className="text-muted-foreground">
        ...
        including AI, may assist with drafting, structuring, and editing articles.
        Our publishing workflow requires material factual claims to be checked
        against the linked official sources cited in the article.
      </p>
