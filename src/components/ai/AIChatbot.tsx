      ...
      <div className="fixed bottom-4 right-4 z-50 md:bottom-5 md:right-5">
        <div className="group relative">
          <a
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition hover:translate-y-[-1px] hover:bg-[#1ebe5d] hover:shadow-xl md:h-10 md:w-10"
            aria-label="Chat on WhatsApp"
          >
            <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current md:h-5 md:w-5" aria-hidden="true">
