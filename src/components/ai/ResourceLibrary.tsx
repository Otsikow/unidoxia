  ...
  const fetchResources = async () => {
    ...
    const mockResources: Resource[] = [
      ...
      },
      {
        ...
        description: 'Comprehensive list of scholarships available for international students studying abroad.',
        type: 'article',
        category: 'scholarship',
        tags: ['scholarship', 'international', 'funding', 'opportunities'],
        author: 'UniDoxia Team',
