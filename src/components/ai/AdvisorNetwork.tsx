    ...
    const mockAdvisors: Advisor[] = [
      {
        ...
        bio: 'With over 10 years of experience in international education, Sarah specializes in helping international students navigate the Canadian university system. She has successfully guided over 500 students to top universities.',
      ...
      },
      {
        ...
        bio: 'Ahmed is a former international student who now helps others achieve their study abroad dreams. He specializes in UK and European universities and understands the unique challenges faced by international students.',
