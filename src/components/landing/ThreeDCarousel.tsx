          ...
          >
            <AnimatePresence initial={false}>
              {cards.map((card, index) => {
                ...
                const scales: Record<Position, number> = {
                  center: 1,
                  left: sideScale,
                  right: sideScale,
                  hidden: 0.72
                };
                const opacities: Record<Position, number> = {
                  center: 1,
                  left: 0.6,
                  right: 0.6,
                  hidden: 0
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute inset-0" aria-hidden>
                        <div className="absolute inset-x-12 top-0 h-40 bg-gradient-to-b from-white/10 to-transparent blur-2xl" />
                        <div className="absolute inset-y-0 right-0 w-1/3 bg-gradient-to-l from-white/10 via-transparent to-transparent backdrop-blur-xl" />
                      </div>
                      ...
                      <div className="relative grid gap-6 px-6 py-8 sm:grid-cols-[1.3fr_1fr] sm:gap-8 sm:px-10 sm:py-12">
                        <div className="space-y-4">
                          ...
                          <h4 className="text-2xl font-semibold leading-tight sm:text-3xl">{card.title}</h4>
                          <p className="text-base text-white/75 sm:text-lg">{card.description}</p>
