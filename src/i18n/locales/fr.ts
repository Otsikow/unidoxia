...
const fr = {
  ...
  layout: {
    ...
    footer: {
      ...
      followUs: "Suivez UniDoxia",
      followUsSubtitle: "Suivez-nous sur X, LinkedIn, Facebook, Instagram et notre canal WhatsApp.",
      social: {
        x: "Suivez-nous sur X",
        xShort: "X",
        ...
        whatsapp: "Suivez le canal UniDoxia.com sur WhatsApp",
