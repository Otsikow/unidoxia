  ...
  pages: {
    index: {
      ...
      aiSearch: {
        ...
        ctaLabel: "शुरू करें",
        stats: [
          { value: "खोजें", label: "अंतरराष्ट्रीय पाठ्यक्रम और विश्वविद्यालय देखें" },
          { value: "समीक्षा", label: "संभावित मिलान और आवश्यकताएँ समझें" },
          { value: "योजना", label: "अगले कदम व्यवस्थित करें" },
        ],
        panel: {
